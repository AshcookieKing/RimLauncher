...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      summary: 'Star Wars Rim Conflict — RP-сервер Clone Wars в Arma 3. Играем за Великую Армию Республики, участвуем в операциях, ивентах и сюжетных линиях.',
    },
    {
      id: 'donations',
  ...
  tutorialSteps: [
    { title: 'Добро пожаловать', text: 'Это лаунчер Rim Conflict. Здесь вы запускаете игру, читаете новости и проходите обучение.' },
    ...
    { title: 'TeamSpeak + TFAR', text: 'Перед запуском игры лаунчер подключит вас к TeamSpeak 185.104.249.127:10026 и установит плагин TFAR.' },
